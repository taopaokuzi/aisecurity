...
| `TASK-013` | Gate 4 | 授权生命周期：提醒、续期、过期回收 | `IN_PROGRESS` | `NOT_READY` | `TASK-012=PASS` | `TASK-012` | `Codex` | `2026-04-17` | [TASK-013-grant-lifecycle-renew-expire.md](./TASK-013-grant-lifecycle-renew-expire.md) | 已领取；准备实现授权生命周期服务、续期 API、提醒/过期任务 |
